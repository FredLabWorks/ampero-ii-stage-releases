...
- **The Delay footswitch LED turns pink** (was red, like drive effects)
- **The scene is shown in Patch + Lock mode** ("S1"…"S2" or any alternate function choosen)
- **Bank+/Bank− load patch 1** of the neighbouring bank
- **Wait mode opens on the current bank to display available patches before switching if needed**
...
Official Facebook group : https://www.facebook.com/groups/1016171734777480
